...
from flowsr.helpers import load_model_weights
from flowsr.helpers import count_params, exists
...
def parse_args():
    parser = argparse.ArgumentParser("FlowSR")
...
def main():
    ...
    exp_name = f"{args.name}/exp_{now}" if exists(args.name) else now
    ...
    def melk(*args, **kwargs):
        ...
        if trainer.global_rank == 0:
            ...
            ckpt_path = os.path.join(ckpt_dir, "last_interrupted.ckpt")
